...
<head>
    ...
    <script>
        ...
        var pusher = new Pusher('a503e353b7b551effe5b', {
            cluster: 'ap2'
        });
            ...
            if (message.name && message.email && message.message) {
                toastr.info(
                    `<div class="notification-content">
                        <i class="fas fa-user"></i> <span>   ${message.name}</span>
                        <i class="fas fa-book" style="margin-left: 20px;"></i> <span>  ${message.email}</span>
                         <i class="fas fa-book" style="margin-left: 20px;"></i> <span>  ${message.message}</span>
                    </div>`,
            ...
            <aside id="default-sidebar" class=" left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0   fixed" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="{{route('crm.quotes')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="{{route('crm.vendor')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="{{route('crm.account')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
